...
### Here, I am performing a practical implementation of the theory learnt during the Summer Analytics Program 2026.
...
2. Handling Categorical Variables using <br>
   ->One Hot Encoding<br>
   ->Ordinal Encoding<br>
